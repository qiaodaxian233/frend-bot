...
**挖矿路径规划(v0.13)**:说"挖隧道"它朝脸冲的方向打 1x2 直巷,说"下矿/挖钻石"它按标准楼梯法挖到钻石层(-58)再直着掏;途中露头的矿全顺手带走(只掏露头不追脉,直巷不挖歪);只碰天然石头——遇到像人修的方块、渗水、贴岩浆、挖穿溶洞都会停下报告,绝不拆家不搭桥。指令 `/frend work tunnel` / `deep`。
