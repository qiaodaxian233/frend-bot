...
聊天关键词(附近 16 格内说话即可,无需指令):跟我来 / 停下 / 过来 / 回家 / 报告 / 砍树 / 挖石头 / 挖矿 / 存箱子 / 收工 / 保护我 / 别打了 / 自由活动 / 别自作主张 / 还记得吗 / 战绩 / 你以后叫XX / 记住:xxx / 你记得什么 / 见过什么 / 挖隧道 / 下矿 / 做工具 / 搓火把 / 你好 / 谢谢……
...
**听懂人话(v0.17,LLM 模式下默认开)**:接了 LLM 后不用踩关键词——"累了,先回去吧"它听懂是回家,"这破洞太黑了"它可能就去搓火把,嘴上还带自己的性格。红线焊死:模型只能从 19 个白名单意图里选词,执行走和关键词完全相同的代码,白名单外的输出一律当聊天——模型永远碰不到游戏本体。
